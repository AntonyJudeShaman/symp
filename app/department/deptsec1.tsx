...
const IconsPage: React.FC = () => {
  return (
    <div
      style={{ maxWidth: "100%" }}
      className="flex justify-center page-height pb-1 mx-auto d-block pt-10 lg:pt-40 d-flex flex-grow-0 flex-wrap h-screen bg-gradient-to-br  from-zinc-50 via-blue-50 to-zinc-50"
    >
      <div className="flex flex-col flex-wrap items-center space-y-2  mb-10    mont lg:mr-20 mr-0">
        <svg
        ...
        <p style={{ fontSize: "6vh" }}>5</p>
        <p style={{ fontSize: "5vh" }}>Departments</p>
      </div>
      <div className="flex flex-col items-center space-y-2 lg:mr-20 mr-0  mb-10 md:mr-20 mont mr-0">
        ...
        <p style={{ fontSize: "6vh", paddingLeft: "10%" }}>30+</p>
        <p style={{ fontSize: "5vh" }}>Events</p>
      </div>
      <div className="flex flex-col items-center space-y-2  space-x-4 mont mr-20 icon ">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="16vh"
